...
special in that they are arrays on the form "[value, test]" where test
...
that are specified in pixels. For instance, for time series the test
...
are available both in the test of the axes (not in pixels) and in
